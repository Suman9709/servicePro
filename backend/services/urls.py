...
from services.views import CategoryView, DeleteServicerequest, ServiceRequestView,ServiceRequestListView, ServiceView, CreateServiceRequestView
...
router.register(r'get-user-service', ServiceRequestListView, basename="get-user-service")
...
urlpatterns =[
    ...
    # path('get-user-service/', ServiceRequestListView.as_view(), name="get-user-service"),
]+ router.urls